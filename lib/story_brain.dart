...
class StoryBrain {
  List<Story> _storyData = [
    Story(
        ...
        choic1: 'I\'ll hop in. Thanks for the help!',
        choic2: 'Better ask him if he\'s a murderer first.'),
    Story(
        storyTitle: 'He nods slowly, unphased by the question.',
        choic1: 'At least he\'s honest. I\'ll climb in.',
        choic2: 'Wait, I know how to change a tire.'),
    Story(
        storyTitle:
            'As you begin to drive, the stranger starts talking about his relationship with his mother. He gets angrier and angrier by the minute. He asks you to open the glovebox. Inside you find a bloody knife, two severed fingers, and a cassette tape of Elton John. He reaches for the glove box.',
        choic1: 'I love Elton John! Hand him the cassette tape.',
        choic2: 'It\'s him or me! You take the knife and stab him.'),
    Story(
        storyTitle:
  ...
  String getChoice1() {
    return _storyData[_storyNumber].choic1;
  }

  String getChoice2() {
    return _storyData[_storyNumber].choic2;
  }
